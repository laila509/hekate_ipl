<img src="https://GitHub.com/laila509/hekate_ipl/blob/master/Atm-readme2.0.jpg?raw=true" align="center" width="80%" /> 
...
【第一章  大气层纯净包整合教程】
    ...
    下hekate_ctcaer_6.0.3.zip，zip解包后是[bootloader]和hekate_ctcaer_6.0.3.bin
...
把hekate_ctcaer.bin重命名payload.bin
...
[atmosphere]，是大气层的核心
  ...
  -|-|-[kip_patches]，大气层插件
    -|-|-[fs_patches]，fs插件，和es插件同理，但分fat32和exfat两个
...
我发的奇乐融合大气层破解包里带的特斯拉核心是Z大发布的，推荐更新。
    ...
    5.相册里的软件，叫它NRO软件，种类也有很多，都是一个.nro文件，多个少个都行，随心添加删除，NRO软件都在TF：switch/，替换最新的.NRO文件就完成，搭配包组合就包含AtmoXL-Titel-Installer.nro游戏安装器、Checkpoint.nro存档管理器等。
